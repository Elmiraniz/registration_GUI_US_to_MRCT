...
% rcl
% inter_dataset_time = BASE.interDataSetTime;
...
%         if BASE.base
% %             Dm.startTime = datetime(str2num(Y),str2num(M),str2num(D),str2num(H),str2num(MI),str2num(S),str2num(MS))-seconds(inter_dataset_time);
%             Dm.startTime = datetime(str2num(Y),str2num(M),str2num(D),str2num(H),str2num(MI),str2num(S),str2num(MS))-seconds(inter_dataset_time);
%         else
...
% subfunction -------------------------------------------------------------
function headerStruct=readInfoFile(fid,headerStruct)
